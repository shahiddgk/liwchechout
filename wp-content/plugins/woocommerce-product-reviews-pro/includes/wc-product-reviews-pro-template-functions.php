...
if ( ! function_exists( 'wc_product_reviews_pro_get_product_rating_count' ) ) {
	 ...
	 *
	 * TODO remove this function as part of WC 3.1 compatibility update {FN 2017-03-22}
	 *
	...
	function wc_product_reviews_pro_get_product_rating_count( $product_id, $rating = null ) {
		...
		_deprecated_function( 'wc_product_reviews_pro_get_product_rating_count()', '1.7.0', 'WC_Product::get_rating_count()' );
