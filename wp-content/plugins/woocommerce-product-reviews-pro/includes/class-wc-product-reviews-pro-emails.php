...
class WC_Product_Reviews_Pro_Emails {
	...
	public function __construct() {
		...
		// @see wc_product_reviews_pro_review_update_confirmation ajax action
	...
	public function add_emails( $emails ) {
		...
		$emails['WC_Product_Reviews_Pro_Emails_New_Comment']				= require_once( wc_product_reviews_pro()->get_plugin_path() . '/includes/emails/class-wc-product-reviews-pro-emails-new-comment.php' );
		$emails['WC_Product_Reviews_Pro_Emails_Review_Update_Confirmation']	= require_once( wc_product_reviews_pro()->get_plugin_path() . '/includes/emails/class-wc-product-reviews-pro-emails-review-update-confirmation.php' );
