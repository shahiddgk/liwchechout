	...
	public function widget( $args, $instance ) {
		...
		if ( $comments ) {
			...
			foreach ( (array) $comments as $comment ) {
				...
				$rating_html  = SV_WC_Plugin_Compatibility::is_wc_version_gte_3_0() ? wc_get_rating_html( $contribution->get_rating() ) : $_product->get_rating_html( $contribution->get_rating() );
