...
class WC_Product_Reviews_Pro extends SV_WC_Plugin {
	...
	private function admin_includes() {
        ...
        // Files has been moved to the new directory but still class names are still old, so we might also need to update class names {FN 2017-04-24}
		require_once( $this->get_plugin_path() . '/includes/admin/class-wc-reviews.php' );
