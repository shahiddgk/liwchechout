...
class WgactAskForRating {
	...
	public static function init() {
		...
		add_action( 'admin_head', 'WgactAskForRating::ask_for_rating_js' );
		add_action( 'wp_ajax_wgact_dismissed_notice_handler', 'WgactAskForRating::ajax_rating_notice_handler' );
		add_action( 'admin_notices', 'WgactAskForRating::ask_for_rating_notices_if_not_asked_before' );
