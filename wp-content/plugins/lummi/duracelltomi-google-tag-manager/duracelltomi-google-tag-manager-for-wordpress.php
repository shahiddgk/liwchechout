<?php
/*
Plugin Name: Google Tag Manager for Wordpress - Intuito Edition
Version: 1.6.1
Plugin URI: https://duracelltomi.com/google-tag-manager-for-wordpress/
Description: The first Google Tag Manager plugin for WordPress with business goals in mind. Includes tags for Lummi Island Wild clubs.
Author: Thomas Geiger and Intuito + BGO
