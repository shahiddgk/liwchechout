...
$GLOBALS["gtm4wp_includefieldtexts"] = array(
  ...
  GTM4WP_OPTION_INCLUDE_POSTID   => array(
	...
	GTM4WP_OPTION_INCLUDE_USERCLUB    => array(
		"label"       => __( "Logged in user club", 'duracelltomi-google-tag-manager' ),
		"description" => __( "Check this option to include the club of the logged in user.", 'duracelltomi-google-tag-manager' ),
		"phase"       => GTM4WP_PHASE_STABLE
	),
