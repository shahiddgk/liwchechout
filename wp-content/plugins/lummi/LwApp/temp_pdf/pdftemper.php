...
if($attributes["orders_data"]){
    ...
    foreach ($orderID as $order) {
        ...
        $html .= '<tr>
                        ...
                        <td width="200" height="20"><a href="mailto:'.$order['UserEmail'].'">'.$order['UserEmail'].'</a></td>
...
//            }
    ...
    $weight_price = $tot_weight_new * $attributes["orders_data"]["order_items"][0]["shipping_price"];
